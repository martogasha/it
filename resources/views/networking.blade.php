@include('header')
<title>Networking Solutions - Dolex IT Solutions & Technology</title>
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="breadcrumb-area">
                    <h2 class="page-title">Networking Solutions</h2>
                    <ul class="breadcrumbs-link">
                        <li><a href="{{url('/')}}">Home</a></li>
                        <li class="active">Networking Solutions</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="col-xl-8 col-lg-7">
                <div class="service-detail-text">
                    <div class="blog-standared-img slider-blog mrb-40">
                        <img class="img-full" src="images/service/nv.jpg" alt="" />
                    </div>
