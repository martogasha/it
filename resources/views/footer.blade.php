            ...
            <div class="row pdb-65">
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div class="widget footer-widget mrr-60 mrr-md-0">
                        <div class="footer-logo">
                            <img src="images/l1.jpg" alt="" class="mrb-25" />
                        </div>
                        <p class="mrb-25">Join us on our Social Media Platforms for more inciting information</p>
                ...
                <div class="col-xl-2 col-lg-6 col-md-6">
                    <div class="widget footer-widget">
                        ...
                        <ul class="footer-widget-list">
                            <li><a href="{{url('websiteDesign')}}">Web Design</a></li>
                            <li><a href="{{url('Networking')}}">Networking Solutions</a></li>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="widget footer-widget mrr-60 mrr-md-0">
                        ...
                        <p class="mrb-30">Subscribe to our Newsletter to get latest updates</p>
            ...
            <div class="row pdt-30 pdb-30 footer-copyright-area">
                <div class="col-xl-12">
                    <div class="text-center">
                        <span>Copyright by Dolex © 2023. All rights reserved </span>
                    </div>
                </div>
            </div>
        </div>
