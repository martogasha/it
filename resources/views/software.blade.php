@include('header')
<title>Software Development - Dolex IT Solutions & Technology</title>
...
<!-- Header Area End -->
<!-- Page Title Start -->
<section class="page-title-section" style="background-image: url({{asset('images/service/sf.jpg')}}")>
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
            ...
            <div class="col-xl-8 col-lg-7">
                <div class="service-detail-text">
                    <div class="blog-standared-img slider-blog mrb-40">
                        <img class="img-full" src="images/service/sd.jpg" alt="" />
                    </div>
                    <h3 class="mrb-15">Service Details</h3>
                    <p class="mrb-40">
                        We develop software that has long-term business value and is specifically adapted to your company processes as well as future requirements.</p>
                    <p class="about-text-block mrb-40">We use best practice techniques and development processes as a base to quickly construct cutting-edge technological solutions in a systematic and methodical manner.</p>
                    <p class="mrb-35">
                        We support our partners in accelerating change in both their businesses and sectors. They make the most of our production-ready custom software development services to strategize new ideas and achieve true commercial benefits. Contact our specialists right away!</p>
                    <div class="service-details-content">
                        <div class="row d-flex">
                            ...
                            <div class="col-lg-12 col-xl-6">
                                <img class="img-full mrb-lg-35" src="images/service/st.jpg" alt="" />
                            </div>
                        </div>
                    </div>
                </div>
